...
function curarPokemon(id){
    ...
    const pokemonmachucado = pokemons[id]

    if (pokemonmachucado.hp <= 80){
        pokemonmachucado.hp = pokemonmachucado.hp + pocao
    }
    if (pokemonmachucado.hp == 90){
        pokemonmachucado.hp = pokemonmachucado.hp + 10
    } 
    else if (pokemonmachucado.hp >=  100) {
        pokemonmachucado.hp = 100
    }
    
    return `${pokemonmachucado.hp}`
}
